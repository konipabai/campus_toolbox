    ...
    >
      ...
      <el-sub-menu index="2">
        ...
        <el-sub-menu index="2-1">
          ...
          <el-menu-item index="2-1-1"><span>审批预约订单</span></el-menu-item>
          <el-menu-item index="2-1-2"><span>审批记录</span></el-menu-item>
        </el-sub-menu>
        <el-sub-menu index="2-2">
          <template #title><span>管理报修订单</span></template>
          <el-menu-item index="2-2-1"><span>审批报修订单</span></el-menu-item>
          <el-menu-item index="2-2-2"><span>审批记录</span></el-menu-item>
        </el-sub-menu>
